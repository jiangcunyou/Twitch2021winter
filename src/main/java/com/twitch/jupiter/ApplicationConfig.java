...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.twitch.jupiter.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "twitch.cvbbcbfs3bqq.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "jiang0112";
